...
const PLANS = [
  {
    ...
    daysLabel: "15 يوم",
    tag: null,
    features: ["3 قيقا نت", "صلاحية 15 يوم", "تفعيل فوري من صفحة تسجيل الدخول"],
  },
  {
    price: 1000,
    gb: 8,
    daysLabel: "شهر",
    tag: "الأكثر طلبًا",
    features: ["8 قيقا نت", "صلاحية شهر", "تفعيل فوري من صفحة تسجيل الدخول"],
  },
  {
    price: 2000,
    gb: 20,
    daysLabel: "شهر",
    tag: "أقوى باقة",
    features: ["20 قيقا نت", "صلاحية شهر", "تفعيل فوري من صفحة تسجيل الدخول"],
  },
];

function orderLink(plan) {
  const msg = `مرحبًا الدار نت 👋 أريد طلب كرت فئة ${plan.price} (${plan.gb} قيقا - ${plan.daysLabel})`;
