    ...
    <main className="mx-auto w-full max-w-[900px] flex-1 px-4 pt-5 pb-7">
      ...
      >
        <div className="mx-auto flex h-28 w-28 items-center justify-center">
          <LottieIcon data={aboutHeroAnim} className="h-28 w-28" />
        </div>
        <div className="mt-2 text-base font-extrabold text-ink">شبكة الدار نت</div>
      ...
      <motion.section
        ...
        className="rounded-3xl border border-ink/8 bg-white p-5 text-center shadow-[0_4px_14px_rgba(15,23,42,0.04)]"
      >
        <div className="mx-auto flex h-24 w-24 items-center justify-center">
          <LottieIcon data={aboutVisionAnim} className="h-24 w-24" />
        </div>
        <div className="mt-1 text-base font-extrabold text-ink">هدفنا</div>
        <p className="mt-1 text-[11px] leading-6 text-muted">
      ...
      <section className="mt-3 grid grid-cols-3 gap-3">
        {values.map((v, i) => (
          <motion.div
            ...
            className="flex flex-col items-center gap-1.5 rounded-2xl border border-ink/8 bg-white p-4 text-center shadow-[0_4px_14px_rgba(15,23,42,0.04)]"
          >
            <div className="flex h-16 w-16 items-center justify-center">
              <LottieIcon data={v.anim} className="h-16 w-16" />
            </div>
            <div className="text-sm font-extrabold text-ink">{v.title}</div>
            <div className="text-[10px] leading-5 text-muted">{v.desc}</div>
          </motion.div>
        ))}
      </section>
    </main>
