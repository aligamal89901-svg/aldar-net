...
function App() {
  ...
  return (
    <div className="flex min-h-screen flex-col pb-24">
      ...
      >
        <div className="flex w-full max-w-md items-center justify-around rounded-[26px] border border-ink/8 bg-white/85 px-1.5 py-2 shadow-[0_16px_40px_rgba(15,23,42,0.14)] backdrop-blur-xl">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              onClick={() => {
